      ...
      <div id="halim_related_movies-2" class="owl-carousel owl-theme related-film">
         ...
         <article class="thumb grid-item post-38498">
            <div class="halim-item">
               <a class="halim-thumb" href="{{route('movie', ['slug' => $hot->slug])}}" title="{{$hot->title}}">
   ...
   <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
      ...
      <section id="halim-advanced-widget-2">
         ...
         <div id="halim-advanced-widget-2-ajax-box" class="halim_box">
            <?php
            $cate_home_movie_take = $cate_home->movie->take(12);
            if (!empty($cate_home_movie_take)) {
            ?>
               @foreach($cate_home->movie->take(12) as $key => $mov)
               <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-37606">
                  <div class="halim-item">
                     <a class="halim-thumb" href="{{route('movie', ['slug' => $mov->slug])}}">
                        <figure><img class="lazy img-responsive" src="{{ asset('public/uploads/movie/'.$mov->image) }}" title="{{$mov->title}}"></figure>
